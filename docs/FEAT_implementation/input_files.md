...
haul_num | Haul | integer <br> float | | Assigned haul number <br> A value of 0 is used for transect intervals where no haul <br> was present or used <br> Rows with empty values are removed

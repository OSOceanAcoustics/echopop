...
switch para.bio_data_type
    case 1   % Acoustic and Trawl survey data
        para.bio.filename.trawl=['' para.data_root_dir 'Biological\2005\US\biodata_haul.xls'];
        para.bio.filename.gear=['' para.data_root_dir 'Biological\2005\US\biodata_gear.xls'];
        para.bio.filename.catch=['' para.data_root_dir 'Biological\2005\US\biodata_catch.xls'];
        para.bio.filename.length=['' para.data_root_dir 'Biological\2005\US\biodata_length.xls'];
        para.bio.filename.specimen=['' para.data_root_dir 'Biological\2005\US\biodata_specimen.xls'];
    ...
    case 3 % US observer trawl data
        para.bio.filename.trawl=['' para.data_root_dir 'Observer Data\Hake_Trawl_Chu_2005.xlsx'];
        para.bio.filename.gear=[''];
        para.bio.filename.catch=['' para.data_root_dir 'Observer Data\Hake_Catch_Chu_2005.xlsx'];
        para.bio.filename.length=['' para.data_root_dir 'Observer Data\Hake_Length_Chu_2005.xlsx'];
        para.bio.filename.specimen=['' para.data_root_dir 'Observer Data\Hake_Age_Chu_2005.xlsx'];
        para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2005\Stratification_geographic_Lat_2005.xlsx'];
end

%% Stratification files
para.bio_acoust.filename.Transect_region_haul=['' para.data_root_dir 'Stratification\2005\US&CAN_T_reg_haul_final.xlsx'];
para.acoust.filename.strata=['' para.data_root_dir 'Stratification\2005\US&CAN strata 2005.xlsx'];
para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2005\Stratification_geographic_Lat_2005.xlsx'];
...
para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\US&CAN_detailsa_2005_table2y+_ALL_final.xlsx'];
...
para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2005\default_vario_krig_settings_final.xlsx'];
% para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2005\default_vario_krig_settings_orig.xlsx'];

% old parameter files
% para.bio_acoust.filename.Transect_region_haul=['' para.data_root_dir 'Stratification\2005\US&CAN_T_reg_haul_final_orig.xlsx'];
% para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2005\Stratification_geographic_Lat_2005_orig.xlsx'];
% para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2005\default_vario_krig_settings_orig.xlsx'];

function  proc_parameters_2009
%% this file is to provide all required input filenames & some process parameter settings
%%
%% Written by Dezhang Chu    Written by Dezhang Chu, NOAA Fisheries, NWFSC
%% Last Modification:       6/24/2013

global para data 

% para.proc.source=3;
if para.proc.source == 1   % US only
    para.bio.filename.trawl_US=['' para.data_root_dir 'Biological\2009\US\biodata_haul.xls'];
    para.bio.filename.gear_US=['' para.data_root_dir 'Biological\2009\US\biodata_gear.xls'];
    para.bio.filename.catch_US=['' para.data_root_dir 'Biological\2009\US\biodata_catch.xls'];
    para.bio.filename.length_US=['' para.data_root_dir 'Biological\2009\US\biodata_length.xls'];
    para.bio.filename.specimen_US=['' para.data_root_dir 'Biological\2009\US\biodata_specimen.xls'];
...
elseif para.proc.source == 2   % CAN only
    para.bio.filename.trawl_CAN=['' para.data_root_dir 'Biological\2009\CAN\biodata_haul.xls'];
    para.bio.filename.gear_CAN=['' para.data_root_dir 'Biological\2009\CAN\biodata_gear.xls'];
    para.bio.filename.catch_CAN=['' para.data_root_dir 'Biological\2009\CAN\biodata_catch.xls'];
    para.bio.filename.length_CAN=['' para.data_root_dir 'Biological\2009\CAN\biodata_length.xls'];
    para.bio.filename.specimen_CAN=['' para.data_root_dir 'Biological\2009\CAN\biodata_specimen.xls'];
...
elseif para.proc.source == 3 % US & CAN acoustic trawl data
    ...
    switch para.bio_data_type
        ...
        case 3 % US observer trawl data
            para.bio.filename.trawl=['' para.data_root_dir 'Observer Data\Hake_Trawl_Chu_2009.xlsx'];
            para.bio.filename.gear=[''];
            para.bio.filename.catch=['' para.data_root_dir 'Observer Data\Hake_Catch_Chu_2009.xlsx'];
            para.bio.filename.length=['' para.data_root_dir 'Observer Data\Hake_Length_Chu_2009.xlsx'];
            para.bio.filename.specimen=['' para.data_root_dir 'Observer Data\Hake_Age_Chu_2009.xlsx'];
            para.proc.source=3;
    end
end
%% Stratification files
para.bio_acoust.filename.Transect_region_haul=['' para.data_root_dir 'Stratification\2009\US&CAN_T_reg_haul_final.xlsx'];
para.acoust.filename.strata=['' para.data_root_dir 'Stratification\2009\US&CAN strata 2009.xlsx'];
para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2009\Stratification_geographic_Lat_2009.xlsx'];
...
para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\US&CAN_detailsa_2009_table2y+_ALL_final.xlsx'];
...
para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2009\default_vario_krig_settings_final.xlsx'];
...
para.proc.CAN_start_transect=78;                % start transect number for transects on Canadian Ship
...
para.bio.haul_no_offset=900;                    % Canadian's trawl number offset

...
if para.proc.source == 1   % US only
    para.bio.filename.trawl_US=['' para.data_root_dir 'Biological\2013\US\biodata_haul.xlsx'];
    para.bio.filename.gear_US=['' para.data_root_dir 'Biological\2013\US\biodata_gear.xlsx'];
    para.bio.filename.catch_US=['' para.data_root_dir 'Biological\2013\US\biodata_catch.xlsx'];
    para.bio.filename.length_US=['' para.data_root_dir 'Biological\2013\US\biodata_length.xlsx'];
    para.bio.filename.specimen_US=['' para.data_root_dir 'Biological\2013\US\biodata_specimen.xlsx'];
...
elseif para.proc.source == 2   % CAN only
    para.bio.filename.trawl_CAN=['' para.data_root_dir 'Biological\2013\CAN\biodata_haul_CAN.xlsx'];
    para.bio.filename.gear_CAN=['' para.data_root_dir 'Biological\2013\CAN\biodata_gear_CAN.xlsx'];
    para.bio.filename.catch_CAN=['' para.data_root_dir 'Biological\2013\CAN\biodata_catch_CAN.xlsx'];
    para.bio.filename.length_CAN=['' para.data_root_dir 'Biological\2013\CAN\biodata_length_CAN.xlsx'];
    para.bio.filename.specimen_CAN=['' para.data_root_dir 'Biological\2013\CAN\biodata_specimen_CAN.xlsx'];
...
elseif para.proc.source == 3 % US & CAN acoustic trawl data
    switch para.bio_data_type
        ...
        case 3   % US observer trawl data
            para.bio.filename.trawl=['' para.data_root_dir 'Observer Data\Hake_Trawl_Chu_2013.xlsx'];
            para.bio.filename.gear=[''];
            para.bio.filename.catch=['' para.data_root_dir 'Observer Data\Hake_Catch_Chu_2013.xlsx'];
            para.bio.filename.length=['' para.data_root_dir 'Observer Data\Hake_Length_Chu_2013.xlsx'];
            para.bio.filename.specimen=['' para.data_root_dir 'Observer Data\Hake_Age_Chu_2013.xlsx'];
    end
end
%% Stratification files
para.bio_acoust.filename.Transect_region_haul=['' para.data_root_dir 'Stratification\2013\US&CAN_2013_T_reg_haul rev.xlsx'];
para.acoust.filename.strata=['' para.data_root_dir 'Stratification\2013\US&CAN strata 2013 12-2-2013.xlsx'];
para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2013\Stratification_geographic_Lat.xlsx'];
...
para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\US&CAN_detailsa_2013_table2y+_ALL_final.xlsx'];
%% compare 1500m with 35 nm west bound
% para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\US&CAN_detailsa_2013_table2y+_ALL_final - 1500m.xlsx'];
...
para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2013\default_vario_krig_settings_final.xlsx'];
% para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2013\default_vario_krig_settings_orig.xlsx'];

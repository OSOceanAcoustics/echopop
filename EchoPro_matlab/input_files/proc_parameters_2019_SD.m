function  proc_parameters_2019_SD
...
if isfield(hdl, 'proc') & strcmp(para.platform_name, 'SD') == 1
   set(hdl.proc.popup_proc_stratification, 'value', 2);  % set to geographic stratification - INPFC
   set(hdl.proc.popup_trawl_data, 'value', 3);      % set to Observer (A-Shop) data  
...
switch para.bio_data_type
    case 1   % Acoustic and Trawl survey data
        ...
        para.krig.vario_krig_para_filename=['' para.data_root_dir 'Kriging files & parameters\2019\default_vario_krig_settings_2019_US - SD.xlsx'];
    ...
    case 3   % US observer trawl data
        para.bio.filename.trawl=['' para.data_root_dir 'Biological\CONFIDENTIAL\Observer Data\Hake_Trawl_Chu_2019.xlsx'];
%         'N:\Survey.Acoustics\Survey Time Series Analysis\Historical
%         Summary (for Kriging)\Biological\CONFIDENTIAL\Observer Data\'
        para.bio.filename.gear=[''];
        para.bio.filename.catch=['' para.data_root_dir 'Biological\CONFIDENTIAL\Observer Data\Hake_Catch_Chu_2019.xlsx'];
        para.bio.filename.length=['' para.data_root_dir 'Biological\CONFIDENTIAL\Observer Data\Hake_Length_Chu_2019.xlsx'];
        para.bio.filename.specimen=['' para.data_root_dir 'Biological\CONFIDENTIAL\Observer Data\Hake_Age_Chu_2019.xlsx'];
        %% Stratification files
        para.acoust.filename.strata=['' para.data_root_dir 'Stratification\2019\Stratification_geographic_Lat_2019_final.xlsx'];
        para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\US&CAN_SD_detailsa_2019_table2y+_ALL_final.xlsx']; 
%         para.acoust.filename.processed_data=['' para.data_root_dir 'Exports\SD2019\US&CAN_SD_detailsa_2019_table2y+_ALL_04-23-2020.xlsx']; 
        para.proc.stratification_filename=['' para.data_root_dir 'Stratification\2019\Stratification_geographic_Lat_2019_final.xlsx'];
...
para.proc.stratification_index=0;               % index for the chosen stratification
...
para.proc.end_transect=85;                     % end transect number

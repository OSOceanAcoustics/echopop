function [tx0,tx1,tx_out1,tx_out2]=transect_region_def_2007(region)
...
%% region 1: paralell transects to latitudes from south of SCB to west of QC IS
    ...
    tx1=111;  % northern most transect number
...
%% region 2: transects paralell to longitudes north of QCI
    ...
    tx1=117;  % west most transect number
%% specifies lower (south) and upper (north) region boundaries based on the transects
    ...
    tx_l=[111.1 [tx0:tx1]+0.6];
    tx_u=[111.4 [tx0:tx1]+0.9];
    tx_out1=tx_l;
    tx_out2=tx_u;
else
    ...
    %% #.6 = south end of transect
    %% #.9 = north end of transect
    tx_l=[119:-1:117 [126:135  137:141] 97]+0.1;
    tx_r=[119.4 118.4 116.9 116.6 [128:135 137:141]+0.4 98.1];
    tx_out1=tx_l;
    tx_out2=tx_r;
end

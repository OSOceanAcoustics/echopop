...
if opt == 1
  ...
  '·	more examples with detailed step by step instructions are provided to allow user(s)'...
  'to master the functionality of the software package more quickly and easily.',...
  '   ',...
  'Although this software package lacks some abilities such as Co-kriging, it does provide',...
  'a convenient tool for geostatistical applications and should also help scientists from other fields.'});
  name='           ABOUT EASYKRIG 3.0';
  window_pos=[0.2 0.2 0.6 0.4];

    ...
    def plot(
        ...
        *See `Plotting parameterization` section for more details*
        ...
        `"transect"`:
            ...
            - **"nasc"**: Vertically integrated acoustic backscatter (nautical area scattering
            coefficient, NASC).
        ...
        ```
        .. code-block:: markdown
            axis_labels: Optional[Dict[str, Any]]
                A dictionary that contains user-defined axis labels:
                - `x`: x-axis label.
                - `y`: y-axis label.

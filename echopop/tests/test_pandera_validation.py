...
from echopop.utils.validate_df import AcousticData, BaseDataFrame, CatchBiodata, GeoStrata, IsobathData, KrigedMesh, KSStrata, LengthBiodata, SpecimenBiodata
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(dict(central_latitude=[np.nan, 0.0, 1.0], 
                              longitude_funny=[-1.0, np.nan, 1.0])),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(
                dict(
                    latitude=[-1.0, 0.0, 1.0], longitude=[-1.0, 0.0, 1.0], 
                    fraction=[np.nan, 0.5, 1.0]
                )
            ),
            pd.DataFrame(
                dict(
                    latitude=[0.0, 1.0], longitude=[0.0, 1.0], fraction=[0.5, 1.0]
                )
            ),
            None,
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], northlimit_latitude=[-91.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
            "greater_than_or_equal_to(-90.0)",
        ),
        (
            pd.DataFrame(dict(haul=[1, 2, 3], northlimit_latitude=[-1.0, 0.0, 91.0], 
                              stratum=[1, 2, 3])),
            None,
            "less_than_or_equal_to(90.0)",
        ),
        ...
        (
            pd.DataFrame(dict()),
            None,
            ["column regex name='haul'", "Column 'northlimit_latitude' not in dataframe", 
             "column regex name='stratum'"]
        ),
        (
            pd.DataFrame(dict(haul=[1, 2, 3], northlimit_latitude=[-1, 0, 1], 
                              stratum=[1, 2, 3])),
            pd.DataFrame(dict(haul=[1, 2, 3], northlimit_latitude=[-1.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], northlimit_latitude=[-1.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            pd.DataFrame(dict(haul=[1, 2, 3], northlimit_latitude=[-1.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], northlimit_latitude=["a", "b", "c"], 
                              stratum=[1, 2, 3])),
            None,
            "Northlimit_latitude column must be a Series of 'float64' values",
        ),
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], northlimit_latitude=["a", 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
            "Northlimit_latitude column must be a Series of 'float64' values",
        ),
        (
            pd.DataFrame(dict(haul_num=[1.0, 2.0, 3.0], northlimit_latitude=[-1.0, 0.0, 1.0], 
                              stratum_num=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1.0, 2.0, 3.0], northlimit_latitude=[-1.0, 0.0, 1.0], 
                              stratum_num=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul_num=[np.nan, 2, 3, 4], 
    ...
    [
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], fraction=[0.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            pd.DataFrame(dict(fraction=[0.0, 0.0, 1.0], haul=[1, 2, 3], 
                              stratum=[1, 2, 3])),
            None,
        ),
        (
            pd.DataFrame(dict(haul=[1, 2, 3], fraction=[-1.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
            "greater_than_or_equal_to(0.0)",
        ),
        (
            pd.DataFrame(dict(haul=[1, 2, 3], fraction=[0.0, 0.0, 2.0], 
                              stratum=[1, 2, 3])),
            None,
            "less_than_or_equal_to(1.0)",
        ),
        ...
        (
            pd.DataFrame(dict()),
            None,
            ["column regex name='haul'", "column regex name='.*fraction.*'", 
             "column regex name='stratum'"]
        ),
        (
            pd.DataFrame(dict(haul=[1, 2, 3], fraction=[0, 0, 1], 
                              stratum=[1, 2, 3])),
            pd.DataFrame(dict(fraction=[0.0, 0.0, 1.0], haul=[1, 2, 3],  
                              stratum=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], fraction=[0.0, 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            pd.DataFrame(dict(fraction=[0.0, 0.0, 1.0], haul=[1, 2, 3],  
                              stratum=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], fraction=["a", "b", "c"], 
                              stratum=[1, 2, 3])),
            None,
            "Fraction column must be a Series of 'float64' values",
        ),
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], fraction=["a", 0.0, 1.0], 
                              stratum=[1, 2, 3])),
            None,
            "Fraction column must be a Series of 'float64' values",
        ),
        (
            pd.DataFrame(dict(haul_num=[1.0, 2.0, 3.0], fraction_catch=[0.0, 0.0, 1.0], 
                              stratum_num=[1, 2, 3])),
            pd.DataFrame(dict(fraction_catch=[0.0, 0.0, 1.0], haul_num=[1.0, 2.0, 3.0], 
                              stratum_num=[1, 2, 3])),
            None,
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(dict()),
            None,
            ["Column 'haul_num' not in dataframe", "Column 'haul_weight' not in dataframe", 
             "Column 'species_id' not in dataframe"]
        ),
        (
            pd.DataFrame(dict(haul_num=[1.0, 2.0, 3.0], haul_weight=[1.0, 2.0, 3.0], 
                              species_id=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], haul_weight=[1.0, 2.0, 3.0], 
                              species_id=[1, 2, 3])),
            None,
        ...
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], haul_weight=["a", "b", "c"], 
                              species_id=[1, 2, 3])),
            None,
            "Haul_weight column must be a Series of 'float64'",
        ),
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], haul_weight=[1.0, "b", "c"], 
                              species_id=[1, 2, 3])),
            None,
            "Haul_weight column must be a Series of 'float64'",
        ),
        (
            pd.DataFrame(dict(haul_num=[np.nan, 2, 3, 4], haul_weight=[1.0, np.nan, 3.0, 4.0], 
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1, 2, 3])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict()),
            None,
            ["Column 'haul_num' not in dataframe", "Column 'length' not in dataframe", 
             "Column 'length_count' not in dataframe", "Column 'sex' not in dataframe",
             "Column 'species_id' not in dataframe"]
        ),
        (
            pd.DataFrame(dict(haul_num=[1.0, 2.0, 3.0], length=[1.0, 2.0, 3.0], 
                              length_count=[1, 2, 3], sex=[1, 2, 3], species_id=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1, 2, 3])),
            None,
        ),
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              length_count=[1.0, 2.0, 3.0], sex=[1, 2, 3], species_id=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1, 2, 3])),
            None,
        ),
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=[1, 2, 3], species_id=[1, 2, 3])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=["male", "female", "unsexed"], species_id=[1, 2, 3])),
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=["male", "female", "unsexed"], species_id=[1, 2, 3])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=["sex1", "sex2", "sex3"], species_id=[1, 2, 3])),
            None,
            "column datatype should either be all 'int', or all 'str' contained within",
        ),
        (
            pd.DataFrame(dict(haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], length_count=[1, 2, 3], 
                              sex=["male", "female", "sex3"], species_id=[1, 2, 3])),
            None,
            "column datatype should either be all 'int', or all 'str' contained within",
        ),
        (
            pd.DataFrame(dict(haul_num=[np.nan, 2, 3, 4, 5], length=[1.0, np.nan, 3.0, 4.0, 5.0], 
                              length_count=[1, 2, np.nan, 4, 5], sex=[1, 2, 3, np.nan, 5], 
                              species_id=[1, np.nan, 3, 4, 5])),
            pd.DataFrame(dict(haul_num=[5], length=[5.0], length_count=[5], sex=[5], 
                              species_id=[5])),
            None,
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
        ),
        (
            pd.DataFrame(dict(age=[-1, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
            "greater_than_or_equal_to(0)",
        ),
        ...
        (
            pd.DataFrame(dict()),
            None,
            ["Column 'age' not in dataframe", "Column 'haul_num' not in dataframe", 
             "Column 'length' not in dataframe", "Column 'sex' not in dataframe", 
             "Column 'species_id' not in dataframe", "Column 'weight' not in dataframe"]
        ),
        (
            pd.DataFrame(dict(age=[0.0, 1.0, 2.0], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
        ...
        (
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1.0, 2.0, 3.0], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
        ...
        (
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1.0, 2.0, 3.0], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, "2b", "3c"], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=[1, 2, 3], species_id=[1, "2b", "3c"], weight=[1.0, 2.0, 3.0])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=["m", "f", "u"], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(age=[0, 1, 2], haul_num=[1, 2, 3], length=[1.0, 2.0, 3.0], 
                              sex=["m", "f", "u"], species_id=[1, 2, 3], weight=[1.0, 2.0, 3.0])),
            None,
        ),
        ...
        (
            pd.DataFrame(dict(age=[np.nan, 2, 3, 4, 5, 6], haul_num=[1, np.nan, 3, 4, 5, 6], 
                              length=[1.0, 2.0, np.nan, 4.0, 5.0, 6.0], sex=[1, 2, 3, np.nan, 5, 6],
                              species_id=[1, 2, 3, 4, np.nan, 6], 
                              weight=[1.0, 2.0, 3.0, 4.0, np.nan, 6.0])),
            pd.DataFrame(dict(age=[6], haul_num=[6], length=[6.0], sex=[6], species_id=[6], 
                              weight=[6.0])),
            None
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        (
            pd.DataFrame(dict(haul=[1], latitude=[1.0], longitude=[1.0], nasc=[1.0], transect=[1], 
                              transect_spacing=[1.0], vessel_log_start=[0.0], 
                              vessel_log_end=[1.0])),
            pd.DataFrame(dict(haul=[1], latitude=[1.0], longitude=[1.0], nasc=[1.0], transect=[1], 
                              transect_spacing=[1.0], vessel_log_start=[0.0], 
                              vessel_log_end=[1.0])),
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], longitude=[1.0, 2.0, 3.0], 
                              nasc=[1.0, 2.0, 3.0], transect=[1, 2, 3], 
                              transect_spacing=[3.0, 3.0, 3.0], vessel_log_start=[0.0, 1.0, 2.0], 
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[-91.0, 2.0, 91.0], 
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], 
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], 
                              longitude=[1.0, 2.0, 3.0], 
                              nasc=[1.0, 2.0, 3.0], transect=[1, 2, 3], 
                              transect_spacing=[3.0, 3.0, 3.0], vessel_log_start=[-1.0, 1.0, 2.0], 
                              vessel_log_end=[1.0, 2.0, 3.0])),
            None,
            "greater_than_or_equal_to(0.0)",
        ),
        ...
        (
            pd.DataFrame(dict(haul=[1.0, 2.0, 3.0], latitude=[1.0, 2.0, 3.0], 
                              longitude=[1.0, 2.0, 3.0], nasc=[1.0, 2.0, 3.0], transect=[1, 2, 3], 
                              transect_spacing=[3.0, 3.0, 3.0], vessel_log_start=[0.0, 1.0, 2.0], 
                              vessel_log_end=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], longitude=[1.0, 2.0, 3.0], 
                              nasc=[1.0, 2.0, 3.0], transect=[1, 2, 3], 
        ...
        (
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], longitude=[1.0, 2.0, 3.0], 
                              nasc=[1.0, 2.0, 3.0], transect=[1.0, 2.0, 3.0], 
                              transect_spacing=[3.0, 3.0, 3.0], vessel_log_start=[0.0, 1.0, 2.0], 
                              vessel_log_end=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(haul=[1, 2, 3], latitude=[1.0, 2.0, 3.0], longitude=[1.0, 2.0, 3.0], 
                              nasc=[1.0, 2.0, 3.0], transect=[1, 2, 3], 
        ...
        (
            pd.DataFrame(dict(haul_name=[1, 2, 3], latitude=[1.0, 2.0, 3.0], 
                              longitude=[1.0, 2.0, 3.0], nasc=[1.0, 2.0, 3.0], 
                              transect_name=[1, 2, 3], 
                              transect_spacing=[3.0, 3.0, 3.0], vessel_log_start=[0.0, 1.0, 2.0], 
                              vessel_log_end=[1.0, 2.0, 3.0])),
            pd.DataFrame(dict(haul_name=[1, 2, 3], latitude=[1.0, 2.0, 3.0], 
        ...
        (
            ...
            pd.DataFrame(dict(haul=[7, 10], latitude=[7.0, 10.0], longitude=[7.0, 10.0], 
                              nasc=[7.0, 10.0], transect=[7, 10], transect_spacing=[7.0, 10.0],
                              vessel_log_start=[7.0, 10.0], vessel_log_end=[7.0, 10.0])),
            None
        )
    ],
    ids=[

...
def test_age1_metric_proportions( ):
            ...
            'distributions': {
                'length_bins_df': pd.DataFrame(
                    { 'length_bins': np.array( [ 12.5 , 17.5 , 22.5 , 27.5 ] ) ,
                      'length_intervals': np.array( [ pd.Interval( left = 10.0 , right = 15.0 ) , 
        ...
        'number': {
            'aged_length_proportions_df': pd.DataFrame(
                { 'stratum_num': np.repeat( [ 1 , 2 ] , 24 ) ,
                  ...
                  'length_bin': np.tile( [ pd.Interval( left = 10.0 , right = 15.0 ) , 
                                           pd.Interval( left = 15.0 , right = 20.0 ) ,
                                           pd.Interval( left = 20.0 , right = 25.0 ) ,
                                           pd.Interval( left = 25.0 , right = 30.0 ) ] , 12 ) ,
                  'age_bin': np.repeat( [ pd.Interval( left = 0.5 , right = 1.5 ) , 
                                          pd.Interval( left = 1.5 , right = 2.5 ) ,
                                          pd.Interval( left = 2.5 , right = 3.5 ) ] , 16 ) ,
                  'sex': np.tile( [ 'all' , 'all' , 'all' , 'all' , 'all' , 'all' , 'all' , 'all' ,
                                    'male' , 'male' , 'male' , 'male' , 'male' , 'male' , 'male' , 'male' ,
                                    'female' , 'female' , 'female' , 'female' , 'female' , 'female' , 'female' , 'female' ] , 2 ) ,
            ...
            'unaged_length_proportions_df': pd.DataFrame(
                { 'stratum_num': np.repeat( [ 1 , 2 ] , 12 ) ,
                  ...
                  'length_bin': np.tile( [ pd.Interval( left = 10.0 , right = 15.0 ) , 
                                           pd.Interval( left = 15.0 , right = 20.0 ) ,
                                           pd.Interval( left = 20.0 , right = 25.0 ) ,
                                           pd.Interval( left = 25.0 , right = 30.0 ) ] , 6 ) ,     
    ...
    age1_metric_proportions( mock_distributions_dict , mock_proportions_dict , mock_TS_L_parameters , mock_settings_dict )

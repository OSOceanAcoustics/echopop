...
def sample_transect_data_cropping():
    ...
    return pd.DataFrame({
        'transect_num': [1, 1, 1, 2, 2, 2, 3, 3, 3, 121, 121, 121, 122, 122, 122, 
                        129, 129, 129, 130, 130, 130],
        'longitude': [-125.0, -125.1, -125.2, -125.5, -125.6, -125.7, -125.0, -125.1, -125.2,
                     -126.0, -126.1, -126.2, -126.5, -126.6, -126.7, -127.0, -127.1, -127.2,
                     -127.5, -127.6, -127.7],
        'latitude': [48.0, 48.1, 48.2, 48.0, 48.1, 48.2, 49.0, 49.1, 49.2,
                    50.0, 50.1, 50.2, 50.0, 50.1, 50.2, 51.0, 51.1, 51.2,
                    51.0, 51.1, 51.2],
        'interval': [1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3, 1, 2, 3],
        'max_depth': [100, 90, 80, 110, 95, 85, 105, 88, 92, 120, 100, 90, 115, 98, 88, 
                     125, 105, 95, 130, 110, 100],
        'layer_depth_min': [15, 25, 35, 15, 25, 35, 15, 25, 35, 15, 25, 35, 15, 25, 35,
                           15, 25, 35, 15, 25, 35],
        'layer_depth_max': [45, 55, 65, 45, 55, 65, 45, 55, 65, 45, 55, 65, 45, 55, 65,
                           45, 55, 65, 45, 55, 65],
        'biomass_density': [10.5, 12.3, 8.7, 15.2, 11.1, 9.8, 13.4, 16.7, 14.2,
                           18.1, 12.5, 10.3, 14.8, 11.9, 13.6, 16.2, 14.5, 12.8,
                           17.3, 15.1, 13.9]
    })
...
def sample_mesh_data_cropping():
    ...
    return pd.DataFrame({
        ...
        'transect_num': np.random.choice([1, 2, 3, 121, 122, 129, 130], len(lon_grid.flatten()))
    })

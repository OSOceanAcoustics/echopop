...
def sample_specimen_data():
    ...
    return pd.DataFrame({
        ...
        "length_bin": pd.Categorical([
            "(10,15]", "(15,20]", "(20,25]", "(25,30]", "(10,15]",
            "(15,20]", "(20,25]", "(25,30]", "(15,20]", "(20,25]"
        ]),
        "age_bin": pd.Categorical([1, 2, 3, 4, 1, 2, 3, 4, 2, 3]),
        "sex": ["male", "female", "male", "female", "unsexed", "male", "female", "unsexed", "male", "female"],
...
def expanded_specimen_dataset():
    ...
    return pd.DataFrame({
        ...
        "length_bin": pd.Categorical(np.random.choice([
...
def data_multiple_groups():
    ...
    return pd.DataFrame({
        ...
        "length_bin": pd.Categorical(["(10,15]", "(15,20]", "(20,25]", "(25,30]", "(10,15]", "(15,20]"]),
...
def real_interpolators():
    ...
    female_interp = interp.interp1d(
        x_female, y_female, kind='linear', bounds_error=False,
    ...
    global_interp = interp.interp1d(
        x_global, y_global, kind='linear', bounds_error=False,
        fill_value=(y_global[0], y_global[-1])
    )
    
    return {
        'male': male_interp,
        'female': female_interp,
        '_global_': global_interp
    }

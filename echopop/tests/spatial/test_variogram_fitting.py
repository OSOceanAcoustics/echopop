...
from echopop.tests.fixtures.fixtures_variogram_fitting import (
    sample_variogram_data,
    sample_variogram_parameters,
    sample_optimization_parameters,
    sample_simple_variogram_data,
    sample_simple_parameters,
    sample_composite_parameters,
)
...
def test_fit_variogram_realistic_data(sample_variogram_data, sample_variogram_parameters, sample_optimization_parameters):

...
from echopop.nwfsc_feat.spatial import quantize_lags, semivariance, empirical_variogram


# ==================================================================================================
# Test quantize_lags
# ------------------
def test_quantize_lags_basic(sample_estimates, sample_variogram_lag_matrix, 
                           sample_variogram_mask_matrix, sample_variogram_azimuth_matrix):
    ...
    assert isinstance(lag_estimates_squared, np.ndarray), "lag_estimates_squared should be numpy array"
...
def test_quantize_lags_with_azimuth_threshold(sample_estimates, sample_variogram_lag_matrix, 
                                            sample_variogram_mask_matrix, sample_variogram_azimuth_matrix):
...
# Test semivariance
# ----------------
def test_semivariance_basic(sample_estimates, sample_lag_estimates, sample_lag_estimates_squared,
                          sample_lag_counts, sample_lag_deviations, sample_head_index):
...
def test_semivariance_output_types(sample_estimates, sample_lag_estimates, sample_lag_estimates_squared,
                                 sample_lag_counts, sample_lag_deviations, sample_head_index):

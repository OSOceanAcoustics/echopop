...
from echopop.nwfsc_feat import spatial, mesh
from echopop.nwfsc_feat.projection import reproject_dataset
from echopop.tests.fixtures.fixtures_variogram import sample_transect_df
...
# ---------------------------------
def test_geostats_project_coordinates_normalize(sample_coordinates_df_with_biomass, sample_mesh_data_with_lonlat):
...
def test_geostats_project_coordinates_crs_error(sample_coordinates_df_with_biomass, sample_mesh_data_with_lonlat):
...
def test_geostats_crop_mesh_with_tuple_return(sample_coordinates_df_with_biomass, sample_mesh_data_with_lonlat):
...
# ---------------------------------
def test_geostats_calculate_empirical_variogram(sample_coordinates_df_with_biomass, 
                                                sample_mesh_data_with_lonlat):
    """Test empirical variogram calculation."""
...
def test_reproject_dataset_different_input_projection():
    ...
    df = pd.DataFrame({
        'x': [500000, 505000, 510000],
        'y': [5200000, 5205000, 5210000],
        'value': [10, 20, 30]
    })

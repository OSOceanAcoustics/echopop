...
def test_hull_crop_parameters(sample_transect_data_cropping, sample_mesh_data_cropping):
    ...
    cropped_mesh1 = hull_crop(sample_transect_data_cropping, sample_mesh_data_cropping, num_nearest_transects=2)
    cropped_mesh2 = hull_crop(sample_transect_data_cropping, sample_mesh_data_cropping, num_nearest_transects=3)
...
def test_hull_crop_buffer_distance(sample_transect_data_cropping, sample_mesh_data_cropping):
    ...
    cropped_mesh1 = hull_crop(sample_transect_data_cropping, sample_mesh_data_cropping, mesh_buffer_distance=1.0)
    cropped_mesh2 = hull_crop(sample_transect_data_cropping, sample_mesh_data_cropping, mesh_buffer_distance=5.0)
...
def test_transect_ends_crop_latitude_resolution(sample_transect_data_cropping, sample_mesh_data_cropping):
...
def test_transect_ends_crop_region_annotation(sample_transect_data_cropping, sample_mesh_data_cropping):

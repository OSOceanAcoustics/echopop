...
def filter_species( dataframe_list: Union[List[pd.DataFrame], pd.DataFrame] , 
                    species_id: np.float64 ) -> tuple[ pd.DataFrame ]:
    """
...
def fit_length_weight_relationship( specimen_data: pd.DataFrame , 
                                    length_distribution: pd.DataFrame ) -> dict :
    """
...
def quantize_number_counts( specimen_data: pd.DataFrame , 
...
def fit_length_weights( proportions_dict: dict , 
                        length_weight_dict: dict ) -> pd.DataFrame :
    """
...
def quantize_weights( specimen_data: pd.DataFrame ,
                      length_data: pd.DataFrame ,
                      length_weight_df: pd.DataFrame ) -> dict :
    """

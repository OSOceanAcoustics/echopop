...
# NASC EXPORTS FILE(S)
NASC_EXPORTS_FILES = DATA_ROOT / "input/Exports/US&CAN_detailsa_2011_table2y+_ALL_final.xlsx"
# NASC EXPORTS SHEET
...
SURVEY_US = 201103 # US survey identifier
SURVEY_CAN = 201103 # CAN survey identifier
...
HAUL_STRATA_FILE = (
    DATA_ROOT / 
    "input/Stratification/US&CAN strata 2011.xlsx"
)
# HAUL STRATIFICATION SHEET MAP
# ---- Valid keys are limited to "ks" and "inpfc"
HAUL_STRATA_SHEETS = {
    "inpfc": "stratification #0 (INPFC)",
    "ks": "stratification by haul #1",
}
# GEOGRAPHIC STRATIFICATION FILE
GEOSTRATA_FILE = (
    DATA_ROOT / 
    "input/Stratification/Stratification_geographic_Lat_rev.xlsx"
)
...
if NASC_PREPROCESSED:
    ...
    logging.info(
        ...
        "     Filename transect pattern: 'T(\\d+(?:\\.\\d+)?)(?=-)'\n"
...
if COMPARE:
    ...
    ECHOPRO_TO_ECHOPOP_FILE_MAP = {
        ...
        "aged_kriged_mesh_biomass_full": {
            "echopro": "EchoPro_kriged_aged_output-2011_1.xlsx",
            "echopop": "kriged_aged_biomass_mesh_full.xlsx"
        },
        "aged_kriged_mesh_biomass_subset": {
            "echopro": "EchoPro_kriged_aged_output-2011_0.xlsx",
        ...
        "aged_transect_biomass_full": {
            "echopro": "EchoPro_un-kriged_aged_output-2011_0.xlsx",
            "echopop": "transect_aged_biomass_report_full.xlsx"
        },
        "aged_transect_biomass_subset": {
            "echopro": "EchoPro_un-kriged_aged_output-2011_1.xlsx",

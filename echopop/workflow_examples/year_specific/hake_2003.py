...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# DATA ROOT DIRECTORY
DATA_ROOT = Path("C:/Data/EchopopData/file_all_years_update_20260303/2003")
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
# NASC EXPORTS FILE(S)
NASC_EXPORTS_FILES = DATA_ROOT / "input/Exports/US&CAN_detailsa_2003_table2y+_ALL_final.xlsx"
# NASC EXPORTS SHEET
...
TRANSECT_REGION_HAUL_SHEET = "03_EchoPro_Hake"
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
SURVEY_CAN = 200316 # CAN survey identifier
...
BIODATA_SHIP_SPECIES = {
    "ships": {
        ...
        # IN ECHOPRO: ONLY CAN DATA WAS USED FOR THIS YEAR
    },
...
HAUL_STRATA_FILE = (
    DATA_ROOT / 
    "input/Stratification/US&CAN strata 2003.xlsx"
)
...
GEOSTRATA_FILE = (
    DATA_ROOT / 
    "input/Stratification/Stratification_geographic_Lat_2003.xlsx"
)
...
HAUL_UID_CONFIG = {
    "ship_id": {"CAN": SHIP_CAN},
    "survey_id": {"CAN": SURVEY_CAN},
...
# ---- NASC [KS]
df_nasc = ingestion.join_strata_by_uid(
    data=df_nasc, strata=df_dict_strata["ks"], default_stratum=1, stratum_name="stratum_ks"
)
...
if COMPARE:
    ...
    ECHOPRO_TO_ECHOPOP_FILE_MAP = {
        ...
        "aged_kriged_mesh_biomass_full": {
            "echopro": "EchoPro_kriged_aged_output-2003_1.xlsx",
            "echopop": "kriged_aged_biomass_mesh_full.xlsx"
        },
        "aged_kriged_mesh_biomass_subset": {
            "echopro": "EchoPro_kriged_aged_output-2003_0.xlsx",
        ...
        "aged_transect_biomass_full": {
            "echopro": "EchoPro_un-kriged_aged_output-2003_0.xlsx",
            "echopop": "transect_aged_biomass_report_full.xlsx"
        },
        "aged_transect_biomass_subset": {
            "echopro": "EchoPro_un-kriged_aged_output-2003_1.xlsx",

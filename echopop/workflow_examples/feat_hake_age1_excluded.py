...
df_nasc = ingestion.join_geostrata_by_latitude(
    data=df_nasc, geostrata=df_dict_geostrata["inpfc"], stratum_name="geostratum_inpfc"
)
# ---- NASC [KS]
df_nasc = ingestion.join_geostrata_by_latitude(
    data=df_nasc, geostrata=df_dict_geostrata["ks"], stratum_name="geostratum_ks"
)
# ---- MESH [INPFC]
df_mesh = ingestion.join_geostrata_by_latitude(
    data=df_mesh, geostrata=df_dict_geostrata["inpfc"], stratum_name="geostratum_inpfc"
)
# ---- MESH [KS]
df_mesh = ingestion.join_geostrata_by_latitude(
    data=df_mesh, geostrata=df_dict_geostrata["ks"], stratum_name="geostratum_ks"
)
...
# NASC
df_nasc_noage1, delta_longitude, delta_latitude = geostatistics.transform_coordinates(
    data=df_nasc_noage1,
